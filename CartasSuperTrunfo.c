...
// Caluculo da densidade populacional e PIB per capita e exibe os resultados 
// populacao / area = densidade populacional
// pib * 1000000000 / populacao = PIB per capita (convertendo o PIB de bilhoes para reais)
